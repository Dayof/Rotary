...
- project's name is hilighted in different color and project's position/title is in italic.
### Team's Profile Page
...
- `_2016_projects` and `_2017_projects` contain projects' profile. They're written in markdown style. 
